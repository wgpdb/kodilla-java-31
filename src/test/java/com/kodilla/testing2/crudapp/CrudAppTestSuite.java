...
public class CrudAppTestSuite {
    ...
    private static final String BASE_URL = "https://wgpdb.github.io";
    ...
    private boolean checkTaskExistsOnTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElements(By.xpath("//a[@class=\"board-title\"]")).stream()
                .filter(aHref -> aHref.findElements(
                        By.xpath(".//div[@title=\"Kodilla Application\"]")).size() > 0)
        ...
        driver.findElements(By.xpath("//form[@class=\"datatable__row\"]")).stream()
                .filter(anyForm ->
                        anyForm.findElement(By.xpath(".//p[@class=\"datatable__field-value\"]"))
                                .getText().equals(taskName))
                .forEach(button -> {
                    WebElement deleteTaskButton = button.findElement(
    ...
    public void shouldCreateTrelloCard() throws InterruptedException {
        ...
        //assertTrue(checkTaskExistsOnTrello(taskName));
